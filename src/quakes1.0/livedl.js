import * as sp from "./seisplotjs.js";
...
const matchPatternV4 = '.*'; //OD_MANZR__H_D_F/MSEED3'; //`FDSN:OD_._._H_D_./MSEED`;
//const matchPatternV4 = 'FDSN:OD_MANZR__H_H_N';
...
// snip start timer
const rtConfig = {
  duration: duration //sp.luxon.Duration.fromISO("PT50M"),
};
...
// Set default overlay grouping all channels for each station
rtDisp.organizedDisplay.setAttribute("overlay","station");
...
// snip start datalink
let datalink = null;
const DATALINK_URL = "ws://live.openseismometer.net:18000/datalink";
